...
function GoogleMapsWithHeatMap() {
  ...
  useEffect(() => {
    ...
    script.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyC0vlRjEjS_xWXZej31nH05s860YuZpETk&libraries=visualization`; // Replace YOUR_API_KEY with your Google Maps API key
    script.async = true;
